    ...
    <div id="detalle">
        <table ng-table class="table table-condensed table-striped table-bordered">
                ...
                <tr ng-init="sumaResumen()" ng-class="{'info': indexCiclo == $index}" ng-init="resetResumen()" ng-repeat="detalle in programacionAceros" ng-mousedown="selectCiclo($index);">
                    ...
                    <!--<th><button ng-if="isNow;" type="button" ng-disabled="detalle.OkMoldesMoldeoRound > detalle.OkMoldesCerrados ? false : true" ng-click="activaBtnCerrado(13);ModelMoldeo($index,1);" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></th>-->
                    <th>
						<button ng-if="isNow;" type="button" ng-click="activaBtnCerrado(13);ModelMoldeo($index,1);" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
                        <button ng-if="isNow;" ng-show = "mUndo" type="button" ng-click="undoCiclos($index,'OK');" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button>
					</th>
                    <th ng-init=" resumen('OkMoldesCerrados',detalle.OkMoldesCerrados)" >{{detalle.OkMoldesCerrados | currency:"":1}}</th>
                    <th>
                        <button ng-if="isNow;" type="button" ng-click="activaBtnCerrado(14);ModelMoldeo($index,3);" class="btn btn-danger btn-sm">
                            <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                        </button>
						 <button ng-if="isNow;" ng-show = "mUndo" type="button" ng-click="undoCiclos($index,'Rechazo');" class="btn btn-danger btn-sm">
