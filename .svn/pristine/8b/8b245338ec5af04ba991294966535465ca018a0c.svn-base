...
">
            ...
            <form class="form-horizontal" id="formuploadajax" enctype="multipart/form-data" name="editableForm" onaftersave="saveProduccion()">
                <div class="row">
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="!mostrar" class="form-control input-sm" type="date" ng-change="produccion.Fecha = Fecha;loadProgramacion();" min="<?=strtotime(date('G:i:s')) < strtotime('06:00') ? date('Y-m-d', strtotime('-1 day',strtotime(date('Y-m-d')))) : date('Y-m-d');?>" max="<?=strtotime(date('G:i:s')) < strtotime('06:00') ? date('Y-m-d', strtotime('-1 day',strtotime(date('Y-m-d')))) : date('Y-m-d');?>" ng-model="Fecha" format-date/>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <textarea aria-describedby="Observaciones" class="form-control input-sm" ng-disabled="!isNow;" ng-change="saveProduccionObs();" ng-model="produccion.Observaciones">{{produccion.Observaciones}}</textarea>
                        </div>
                    </div>
                </div>
                <?php if($IdSubProceso == 10):?>
                <div class="row">
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" disabled="" class="form-control input-sm"  ng-model="produccion.lances.idAleacion.Identificador" value="{{produccion.lances.idAleacion.Identificador}}"/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control input-sm" ng-disabled="!isNow;" ng-change="updateLances();" ng-model="produccion.lances.HornoConsecutivo" value="{{produccion.lances.HornoConsecutivo}}"/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control input-sm" ng-disabled="!isNow;" ng-change="updateLances();" ng-model-options="{updateOn: 'blur'}" ng-model="produccion.lances.Colada" value="{{produccion.lances.Colada}}"/>
                        </div>
                    </div>
					<div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control input-sm" ng-disabled="!isNow;" ng-change="updateLances();" ng-model-options="{updateOn: 'blur'}" ng-model="produccion.lances.Lance" value="{{produccion.lances.Lance}}"/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control input-sm" ng-disabled="!isNow;" ng-change="updateLances();" ng-model-options="{updateOn: 'blur'}" ng-model="produccion.lances.inicioLance" value="{{produccion.lances.inicioLance |limitTo : 5 :0 }}"/>
                        </div>
                    </div>
					 <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input class="form-control input-sm" ng-disabled="!isNow;" ng-change="updateLances();" ng-model-options="{updateOn: 'blur'}" ng-model="produccion.lances.horaVaciado" value="{{ produccion.lances.horaVaciado |limitTo : 5 :0  }}"/>
                        </div>
                     </div>
                ...
                <div class="row">
                    <!-- <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control" ng-model="produccion.lances.Kellblocks" ng-model-options="{updateOn: 'blur'}" ng-change="updateLances();" ng-value="{{produccion.lances.Kellblocks}}"/>
                        </div>
                    </div> -->
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control" ng-model="produccion.lances.Lingotes" ng-model-options="{updateOn: 'blur'}" ng-disabled="!isNow;" ng-change="updateLances();" ng-value="{{produccion.lances.Lingotes}}"/>
                        </div>
                    </div>
                   <!--  <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input ng-show="mostrar" class="form-control" ng-model="produccion.lances.Probetas" ng-model-options="{updateOn: 'blur'}" ng-change="updateLances();" ng-value="{{produccion.lances.Probetas}}"/>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <button class="btn btn-success" ng-if="isNow();" ng-click="updateProduccion();" ng-show="mostrar">Guardar</button>
                        <button class="btn" ng-if="produccion.IdProduccionEstatus !== '2'" ng-click="cerrarProduccion();" ng-show="mostrar">Cerrar Captura</button>
                        <?php if($IdSubProceso == 10):?>
                        <button ng-click="getData();buscar2();" class="btn btn-info">Mantenimiento de Hornos</button>
                        <?php endif;?>
    ...
    <h4><span class="label label-danger"><b>Avisos:</b> Ya no se pueden hacer capturas de dias anteriores</span></h4>
