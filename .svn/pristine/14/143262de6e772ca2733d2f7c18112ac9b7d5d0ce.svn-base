...
<div ng-app="programa">
    ...
    ">
        ...
        <div id="encabezado" class="row" ng-repeat="certificado in certificados" >
                ...
                <form class="form-horizontal" id="formuploadajax" enctype="multipart/form-data" name="editableForm" >
                    <div class="row">
                        <div class="col-md-2">
                            <div class="input-group">
                                ...
                                <input ng-show="mostrar" disabled="" class="form-control input-sm" value="{{certificado.Fecha}}"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <!--<select class="form-control input-sm" ng-model="IdTipoCertificado" required>
                                    <option ng-selected="certificado.IdTipoCertificado == certificado.IdTipoCertificado" value="{{certificado.IdTipoCertificado}}" ng-repeat="certificado in tiposcerty">{{certificado.Certificado}}</option>
                                </select>-->
                                       
                                <select ng-show="!mostrar" aria-describedby="TipoCertificado" class="form-control input-sm" ng-model="IdTipoCertificado" required>
                                ...
                                <input ng-show="mostrar" disabled="" class="form-control input-sm" value="{{certificado.idTipoCertificado.Certificado}}"/>
                        
                            </div>
                        </div>

                        <div class="col-md-2">
                            <div ng-show="IdTipoCertificado == 10 || certificado.IdTipoCertificado == 10" class="input-group">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <textareag ng-show="mostrar" disabled="" aria-describedby="Observaciones" class="form-control input-sm">{{certificado.Observaciones}}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <b>Registro: {{index+1}} de {{countcerty.length}}</b>
