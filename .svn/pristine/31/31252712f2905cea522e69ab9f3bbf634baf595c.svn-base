<div ng-controller="Pruebas" ng-init="load('data-filtros',{semana:semanaActual,IdArea:<?=$IdArea?>})"></div>
<b style="font-size: 14pt;"></b><input type="week" ng-model="semanaActual" /><button class="btn" ng-click="load('data-filtros',{semana:semanaActual,IdArea:<?=$IdArea?>})">Ver</button>
