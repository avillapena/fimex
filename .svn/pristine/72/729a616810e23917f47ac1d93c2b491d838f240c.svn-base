...
<div class="container-fluid" ng-controller="ProduccionAceros" ng-init="
	...
	<?php if(($IdSubProceso == 9 && $IdArea == 2) ):?>
        IdCentroTrabajo = 41;
    <?php endif?>
...
">
    ...
    <div id="completo" ng-model="completo" >
        <div class="centrado">
            <span class="label label-danger"><b>Avisos:</b> Ya no se pueden hacer capturas de dias anteriores</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="margin-left:40px">
                        <div class="input-group" >
                            ...
                            <button ng-click="buscar3();" ng-if="isNow;" class="btn btn-info">Edicion</button>
                        </div>
                    </div>
                    <?php }?>
                </div>
