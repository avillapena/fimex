...
">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-6">
                    <?= $this->render('FormProduccionAlmasDetalle2',[
                        'IdSubProceso'=>$IdSubProceso,
                    ]);?>
                </div>
                <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <?= $this->render('FormProduccionRechazo',[
                'IdSubProceso'=>$IdSubProceso,
                'titulo' => "Control de rechazo"
            ]);?>
        </div>
        <div class="col-md-3" ng-if="produccion.idMaquina.Descripcion == 'Soldadura'">
            <?= $this->render('FormProduccionMaterial',[
                'subProceso'=>$IdSubProceso,
            ]);?>
        </div>
        ...
        <div id="Busqueda" style="height: 400px;overflow: auto;" scrolly="buscar(filtro);"><table class="table table-bordered table-responsive">
            <thead>
                <tr>
                    ...
                    <th>Fecha</th>
                    <th>Turno</th>
                    <th ng-show="IdSubProceso == 10">Lance</th>
                    <th>Empleado</th>
                    <th>Maquina</th>
                    <th>Producto</th>
                    <th rowspan="2">Buenas</th>
                    <th rowspan="2">Rechazadas</th>
                </tr>
                <tr>
                    ...
                    <th ng-show="IdSubProceso == 10"><input class="form-control" ng-change="reset();buscar(filtro);" ng-model="filtro.Lance"></th>
