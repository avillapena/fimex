...
use common\models\datos\AreaActual;
 ...
 * @property FechaMoldeoCopy[] $fechaMoldeoCopies
...
class Productos extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Identificacion', 'Descripcion', 'Ensamble', 'LlevaSerie', 'CodigoCliente', 'MoldeCompleto'], 'string'],
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getFechaMoldeoCopies()
    {
        return $this->hasMany(FechaMoldeoCopy::className(), ['IdExistencia' => 'IdProducto']);
    }
    ...
    {
        return $this->hasMany(Temperaturas::className(), ['IdProducto' => 'IdProducto']);
    }
