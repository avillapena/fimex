        ...
        <table ng-table class="table table-condensed table-striped table-bordered">
                ...
                <tr ng-class="{'info': indexDetalle == $index}" ng-repeat="detalle in programacionAceros">
                    ...
                    <th ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie)">
                        <!--Moldeo Especial-->
                        <button ng-if="isNow;" type="button" ng-show="IdSubProceso == 17" ng-click="ModelMoldeo($index,1);" class="btn btn-success btn-sm">
                    ...
                    <th ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie)">
                        <button ng-if="isNow;" type="button" ng-show="IdSubProceso == 6" ng-click="ModelMoldeo($index,3); MostrarSeries(detalle.IdProducto,<?= $IdSubProceso; ?>);" class="btn btn-danger btn-sm">
                    ...
                    <th>
                        <button ng-if="isNow;" type="button" ng-click="activaBtnCerrado(15);ModelMoldeo($index,10);" class="btn btn-info btn-sm">
                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                        </button>
                    </th>
                    ...
                    <th ng-show="IdSubProceso == 8 && (detalle.Llenada - detalle.Cerradas) > 0 "><button ng-if="isNow;" type="button" ng-click="ModelMoldeo($index,1);" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></th>
                ...
                <?php if($IdSubProceso != 17): ?>
                <th><button ng-if="isNow;" type="button" ng-show="(IdSubProceso == 9)" ng-click="activaBtnCerrado(13);ModelMoldeo($index,1);" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></th>
                <th>{{detalle.OKCerrado | currency:"":1}}</th>
                <th>
                    <button ng-if="isNow;" type="button" ng-show="IdSubProceso == 9" ng-click="activaBtnCerrado(14);ModelMoldeo($index,3);" class="btn btn-danger btn-sm">
                        <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                    </button>
                </th>
