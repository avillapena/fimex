    ...
    [ //menu para bronces
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Analisis Pedidos', 'url' => ['/programacion/analisis-pedidos-bronces'], 'visible'=>$role == 1 ? true : false],
                '<li class="divider"></li>',
                '<li class="dropdown-header">Embarques</li>',
                '<li class="divider"></li>',
                ['label' => 'Programacion Embarques', 'url' => ['/programacion/embarques-bronces'], 'visible'=>$role == 1 ? true : false],
