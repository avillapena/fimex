...
class AppAsset extends AssetBundle
{
    ...
    public $js = [
        ...
        'js/angular/ng-infinite-scroll.js',
        //'js/angular/angular-dragdrop.js',
        'js/angular/angular-mocks.js',
        'js/jquery.stickytableheaders.js',
        'js/angular.modules.js',
        //'js/angular/ng-file-upload/ng-file-upload-shim.min.js',
        //'js/angular/ng-file-upload/ng-file-upload.min.js',
        'js/angular/angular-file-upload.js',
        'js/angular.produccion_acero.js',
        'js/angular.produccion.js',
        'js/angular.produccionLimpieza.js',
        'js/angular.productos.js',
        'js/angular.embarques.js',
        //'js/angular.tratamientos.js',
        //'js/angular.tratamientos.js',
        'js/angular.pruebas.js',
        'js/angular.certificados.js',
        'js/angular.almas.programacion.js',
        'js/angular.certificados.js',
        'js/angular.programacion.js',
        'js/angular.programacionLimpieza.js',
        'js/angular.inventarios.js',
