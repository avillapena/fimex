                ...
                <tbody>
                    <tr ng-repeat="captura in capturados" 
                        ...
                        <th>
                            ...
                            <select class="form-control" ng-model="captura.Tipo" ng-change="revisaSerie($index);sumarTotal($index);" required>
                                <option  ng-repeat="tc in tipoCalidad" ng-selected="captura.tipo == tc.valor" value=" {{tc.valor}}"> {{tc.descripcion}}</option> 
                            </select>
                        </th>
                        <th>
                            <input class="form-control input-sm" ng-change="revisaSerie($index);sumarTotal($index);" type="text" ng-model="captura.Cantidad" ng-value="captura.Cantidad" />
                        </th>
                        <th>
                            <input class="form-control input-sm" ng-change="sumarTotal($index);" type="text" ng-model="captura.Penetracion" ng-value="captura.Penetracion" />
                        </th>
                        <th>
                            <input class="form-control input-sm" ng-change="sumarTotal($index);" type="text" ng-model="captura.Revelado" ng-value="captura.Revelado" />
                        </th>                    
                        <th>
                            <button 
                            ...
                            <button 
                                ...
                                class="btn btn-success btn-xs" 
                                ng-click="showEvidencias($index);calidadSeries($index);loadCalidadSeries()" >
