    ...
    <div id="detalle">
        <table ng-table class="table table-condensed table-striped table-bordered" 	
            ...
            <tr ng-init="sumaResumen()" ng-class="{'info': indexCiclo == $index}" ng-repeat="detalle in programacionAceros | filter:filtro" ng-mousedown="selectCiclo($index);" ng-init="detalle.Prioridad != 'true' ? 'false' : 'true'">
                ...
                <th colspan="6" ng-show="!detalle.IdParteMolde && detalle.LlevaSerie">NO SE HA COLCADO EL COMPONENTE DONDE VA LA SERIE</th>
                <th ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie) && !(!detalle.IdParteMolde && detalle.LlevaSerie)">
                    <button type="button" ng-if="isNow;" ng-click="saveDetalleAcero($index,1);" class="btn btn-success btn-sm">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                    </button>
                    <button ng-show="mUndo" ng-if="isNow;" type="button"  ng-click="undoCiclos($index,'OK');" class="btn btn-success btn-sm">
                ...
                <th ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie) && !(!detalle.IdParteMolde && detalle.LlevaSerie)">
                    <button type="button" ng-if="isNow;" ng-click="activaBtnCerrado(16);ModelMoldeo($index,4); MostrarSeries(detalle.IdProducto,<?= $IdSubProceso; ?>);" class="btn btn-danger btn-sm">
                        <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                    </button>
                ...
                <th ng-init="resumen('RecCiclosMoldeo',detalle.RecCiclosMoldeo) " ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie) && !(!detalle.IdParteMolde && detalle.LlevaSerie)">{{detalle.RecCiclosMoldeo}}</th>
                <th ng-show="!(!detalle.SerieInicio && detalle.LlevaSerie) && !(!detalle.IdParteMolde && detalle.LlevaSerie)">
