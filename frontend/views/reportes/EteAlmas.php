<div ng-controller="Pruebas" ng-init="IdTurno = 0;load('data-ete',{
    IdArea: 3,
    IdSubProceso: 2,
    FechaIni:FechaIni,
    IdTurno:IdTurno,
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="input-group">
                <span id="Maquinas" class="input-group-addon">Turno:</span>
                <select class="form-control" ng-model="IdTurno" ng-required="true">
                    <option ng-checked="IdTurno == 0" value="0">Ambos</option>
                    <option ng-checked="IdTurno == 1" value="1">Matutino</option>
                    <option ng-checked="IdTurno == 3" value="3">Nocturno</option>
                </select>
            </div>
        </div>
