...
class VProgramacionesAlmaSemana extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['IdProducto', 'IdAlmaTipo', 'Alma', 'IdAlmaReceta', 'AlmaReceta', 'IdAlmaMaterialCaja', 'MaterialCaja', 'IdProgramacionAlma', 'IdProgramacionAlmaSemana', 'IdArea', 'Anio', 'Semana'], 'required'],
            [['IdProducto', 'IdAlmaTipo', 'IdAlmaReceta', 'IdAlmaMaterialCaja', 'Existencia', 'PiezasCaja', 'PiezasMolde', 'IdProgramacionAlma', 'IdProgramacionAlmaSemana', 'IdArea', 'Anio', 'Semana'], 'integer'],
